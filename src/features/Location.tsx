...
export default function Location({ id }: { id: string }) {
  return (
    <Section id={id} className="bg-dark-2 py-32 border-b border-border-light relative" aria-labelledby="location-heading">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-10">
          <header className="flex flex-col gap-6">
            <FadeUp>
              <span className="text-gold-2 text-[10px] md:text-sm font-semibold tracking-[0.3em] uppercase">Contato & Localização</span>
            </FadeUp>
            <FadeUp delay={0.1}>
              <h2 id="location-heading" className="text-4xl md:text-[3.5rem] font-headings font-light text-text-1">
                Como nos <span className="font-serif italic text-gold-2">Encontrar</span>
              </h2>
            </FadeUp>
          ...
          <div className="flex flex-col gap-8 mt-4">
             <FadeUp delay={0.3} className="flex gap-6 items-start group">
                ...
                <div className="flex flex-col gap-1">
                   <strong className="text-text-1 uppercase tracking-widest text-xs">Endereço</strong>
             ...
             <FadeUp delay={0.4} className="flex gap-6 items-start group">
                ...
                <div className="flex flex-col gap-1">
                   <strong className="text-text-1 uppercase tracking-widest text-xs">Horário de Funcionamento</strong>
                   <p className="text-text-2 font-light text-sm lg:text-base">
             ...
             <FadeUp delay={0.5} className="flex gap-6 items-start group">
                ...
                <div className="flex flex-col gap-1">
                   <strong className="text-text-1 uppercase tracking-widest text-xs">Telefone / Reservas</strong>
                   <p className="text-text-2 font-light text-sm lg:text-base">
                      +55 (11) 99999-9999<br />
                      +55 (11) 3000-0000
                   </p>
             ...
             <FadeUp delay={0.6} className="flex gap-6 items-start group">
                ...
                <div className="flex flex-col gap-1">
                   <strong className="text-text-1 uppercase tracking-widest text-xs">E-mail Comercial</strong>
                   <p className="text-text-2 font-light text-sm lg:text-base">
        ...
        <FadeUp delay={0.4} className="w-full h-[400px] lg:h-full min-h-[500px] bg-dark-1 border border-border-light relative overflow-hidden group">
